 ...
 * @method static \Illuminate\Http\Client\Response filterProjectsByAddress(string|null $street = null, string|null $city = null, \Scanifly\Enums\Address\US\State|string|null $state = null, string|null $zipCode = null)
 * @method static \Illuminate\Http\Client\Response filterProjectsByCityAndState(string $city, \Scanifly\Enums\Address\US\State|string $state)
 * @method static \Illuminate\Http\Client\Response filterProjectsByState(\Scanifly\Enums\Address\US\State|string $state)
 * @method static \Illuminate\Http\Client\Response filterProjectsByZipCode(string $zipCode)
